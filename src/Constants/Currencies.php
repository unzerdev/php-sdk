<?php
/**
 * This file contains definitions of the supported currency codes.
 *
...
class Currencies
{
    ...
    const RENMINBI_CHINESE_YUAN = 'CNY';
    ...
    const NAD_2_NAMIBIAN_DOLLAR = 'NAD';
    ...
    const PAPUA_NEW_GUINEAN_KINA_ALT = 'PGK';
    ...
    const TONGAN_PAANGA = 'TOP';
    const TURKISH_LIRA = 'TRY';
    const TRINIDAD_AND_TOBAGO_DOLLAR = 'TWD';
    const TRINIDAD_AND_TOBAGO_DOLLAR_ALT = 'TTD';
    ...
    const UYU_2_URUGUAYAN_PESO = 'UYU';
