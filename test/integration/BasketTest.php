...
class BasketTest extends BaseIntegrationTest
{
     ...
     * @test
     */
    public function V2BasketShouldBeCreatableAndFetchable(): void
    {
        $orderId = microtime(true);
        $basket = new Basket();
        $basket->setTotalValueGross(100)
     ...
     * @test
     */
    public function maxV2BasketShouldBeCreatableAndFetchableWorkAround(): void
    {
        $orderId = 'o'. self::generateRandomId();
        $basket = new Basket();
     ...
     * @param null $exceptionCode
     */
    public function v2BasketItemWithInvalidUrlWillThrowAnError($expectException, $imageUrl, $exceptionCode = null): void
    {
     ...
     * @test
     */
    public function v2BasketShouldBeUpdateable(): void
    {
     ...
     * @test
     */
    public function authorizeTransactionsShouldPassAlongTheV2BasketIdIfSet(): void
    {
     ...
     * @test
     */
    public function chargeTransactionsShouldPassAlongTheV2BasketIdIfSet(): void
    {
        $basket  = $this->createV2Basket();
        $this->assertNotEmpty($basket->getId());
     ...
     * @test
     */
    public function authorizeTransactionsShouldCreateV2BasketIfItDoesNotExistYet(): void
    {
        $orderId = 'b' . self::generateRandomId();
        $basket = new Basket($orderId);
        $basket->setTotalValueGross(99.99)
     ...
     * @test
     */
    public function chargeTransactionsShouldCreateV2BasketIfItDoesNotExistYet(): void
    {
        $orderId = 'b' . self::generateRandomId();
        $basket = new Basket($orderId);
        $basket->setTotalValueGross(99.99)
